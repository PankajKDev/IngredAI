    ...
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700/50 hover:border-purple-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10 group">
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="w-full py-2 px-4 bg-gradient-to-r from-purple-600 to-orange-500 text-white font-medium rounded-lg hover:from-purple-700 hover:to-orange-600 transition-all duration-200 hover:shadow-lg hover:shadow-purple-500/25"
        >
          View Recipe
        </button>
      </div>
